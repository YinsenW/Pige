...
export class NotesService {
  ...
  resolveManagedPageTarget(ownerId: string, input: NotesManagedPageTargetInput, pageType: "note" | "question" | "claim" | "concept" | "entity" | "trashable_page" | "lifecycle_page"): NotesTrashResolution {
    const vault = this.#vaults.current();
    const vaultPath = this.#vaults.activeVaultPath();
