      ...
      >
        ...
        {blocked ? (
          ...
          <LibraryPanel
            ...
            onCurrentNoteSourceReconnected={adoptReconnectedNote} onArchiveCurrentNote={(request) => window.pige.notes.archiveCurrent(request)} onCurrentNoteArchived={adoptMergedNote} onRestoreArchivedNote={(request) => window.pige.notes.restoreArchived(request)} onCurrentNoteRestored={adoptMergedNote} onRenameCurrentNote={(request) => window.pige.notes.rename(request)} onCurrentNoteRenamed={adoptMergedNote} onAddNoteTag={(request) => window.pige.notes.addTag(request)} onCurrentNoteTagged={adoptMergedNote}
