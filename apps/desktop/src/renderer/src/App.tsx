    ...
    return (
      <section className="library-page reader-page" aria-label={props.t("note.reader")}>
        ...
        <NoteReader
          ...
          onSetQuestionState={(request) => window.pige.notes.setQuestionState(request)} onSetClaimConfidence={(request) => window.pige.notes.setClaimConfidence(request)} onSetEntityType={(request) => window.pige.notes.setEntityType(request)} onSearchEntityMentions={(request) => window.pige.notes.searchEntityMentions(request)} onChangeEntityMention={(request) => window.pige.notes.changeEntityMention(request)} onSearchQuestionAnswers={(request) => window.pige.notes.searchQuestionAnswers(request)} onChangeQuestionAnswer={(request) => window.pige.notes.changeQuestionAnswer(request)} onSearchClaimContradictions={(request) => window.pige.notes.searchClaimContradictions(request)} onChangeClaimContradiction={(request) => window.pige.notes.changeClaimContradiction(request)} onSearchConceptParents={(request) => window.pige.notes.searchConceptParents(request)} onChangeConceptParent={(request) => window.pige.notes.changeConceptParent(request)} onSearchTopicParents={(request) => window.pige.notes.searchTopicParents(request)} onChangeTopicParent={(request) => window.pige.notes.changeTopicParent(request)}
