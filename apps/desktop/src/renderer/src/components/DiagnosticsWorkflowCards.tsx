    ...
    <div className="settings-card settings-diagnostics-job" aria-live="polite" data-diagnostics-job-id={props.job.jobId}>
      <div className="settings-row tall">
        ...
        <div className="settings-row-control">
          ...
          {props.job.canReveal ? <button className="settings-button" type="button" disabled={props.busy} onClick={props.onReveal}>{props.t("system.revealSupportBundle")}</button> : null}
