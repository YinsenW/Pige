...
export function NoteAgentPanel(props: {
  ...
  readonly onProposalAction?: (proposalId: string, action: "reject" | "later" | "apply" | "keep_current" | "apply_proposed" | "save_proposed_as_new_page" | "manual_edit") => void;
                ...
                >
                  ...
                  {props.proposal.state === "conflicted" && props.proposal.currentRevision ? (
                    <div className="proposal-actions">
                      {(["manual_edit", "keep_current", "save_proposed_as_new_page", "apply_proposed"] as const).map((action) => (
                        <button
                          key={action}
