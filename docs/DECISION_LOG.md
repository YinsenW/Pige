...
- Text and preserved-PDF verticals use Pi tool events for inspect, PDF parse/optional
  OCR, re-inspect, and cited publication; Office/direct-image/PPTX OCR/retrieval remain.
