...
revision. Dataset query stays read-only. Collection cell, row add/trash or column add/rename mutation
...
- `create_dataset_revision`, `update_collection_cell`, `add_collection_row`, `add_collection_column`, `rename_collection_column`, `trash_collection_row`.
