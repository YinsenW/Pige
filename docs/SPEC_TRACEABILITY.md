...
| PIGE-DATA-003 | Managed Collections support stable typed fields, views, relations/formulas/lookups/rollups, and reversible Agent row/schema/view changes through Activity/Undo; destructive, external-write, authority, and conflict boundaries remain exceptional. | `docs/DATA_ARCHITECTURE.md` | P7 | M5 | integration |
