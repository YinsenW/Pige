...
| PIGE-DIAG-002 | Support bundles are user-initiated, previewed, redacted by default, cancelable, and written only to a selected local path; bounded redacted recent errors may only seed their existing explicit preview. | `docs/DIAGNOSTICS_AND_OBSERVABILITY.md` | P1 | M1 | integration |
