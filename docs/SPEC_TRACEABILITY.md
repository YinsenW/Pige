...
| PIGE-PI-001 | Pi Agent integration is mediated by Pige services; renderer code never talks to Pi directly. | `docs/PI_AGENT_AND_MODEL_PROVIDER_INTEGRATION.md` | P3 | M3 | integration |
