...
| PIGE-KNOW-003 | Evidence-bound reversible relationship/merge/hierarchy, bounded Entity-identifier correction, and directed Claim-support correction work auto-apply with Operations; destructive loss or unresolved conflict needs intervention. | `docs/KNOWLEDGE_MODEL_AND_LINKING.md` | P7 | M5 | integration |
