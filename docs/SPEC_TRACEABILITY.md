...
| PIGE-SEC-003 | Attachments grant exact accepted-SourceRecord snapshot authority only; explicit authored ambient intent may separately use precise confirmation/reviewed effects, never live-path, attachment, fallback, or model inference. | `docs/SECURITY_THREAT_MODEL.md` | P8 | M5 | integration |
