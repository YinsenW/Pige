...
| PIGE-PI-003 | Registered Pi tools pass owning-service validation and exact standing/gesture/Broker authority checks; neither Pige ownership nor extensions can bypass the gate. | `docs/PI_AGENT_AND_MODEL_PROVIDER_INTEGRATION.md` | P8 | M5 | integration |
