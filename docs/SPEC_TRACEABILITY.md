...
| PIGE-VAULT-003 | After Send, each accepted local file gets one private Job snapshot; managed copy adopts it, while reference-original keeps provenance and tools read the snapshot. | `docs/SOURCE_STORAGE_STRATEGY.md` | P2 | M2 | integration |
