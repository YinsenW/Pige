...
| PIGE-PI-001 | The supported upstream Pi runtime is the Agent core behind one thin Pige adapter; product code cannot bypass it or maintain a parallel Agent/provider loop. | `docs/PI_AGENT_AND_MODEL_PROVIDER_INTEGRATION.md` | P3 | M3 | integration |
