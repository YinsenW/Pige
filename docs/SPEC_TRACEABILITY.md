...
| PIGE-KNOW-003 | Evidence-bound reversible relationship/merge/hierarchy and bounded Entity-identifier correction work auto-applies with Operations; destructive loss or unresolved conflict needs intervention. | `docs/KNOWLEDGE_MODEL_AND_LINKING.md` | P7 | M5 | integration |
