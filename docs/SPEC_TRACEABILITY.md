...
| PIGE-VAULT-002 | Stable IDs are independent from slugs and file paths; active-note title/filename rename preserves `page_id`. | `docs/SYNC_CONFLICT_AND_MIGRATION.md` | P1 | M1 | unit |
