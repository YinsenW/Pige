...
| PIGE-JOB-002 | Retry/recovery adopts exact effects, ingress snapshots, and reviewed-plan steps without duplicates; cleanup needs terminal/adopted ownership and no reader. | `docs/JOB_OPERATION_AND_RECOVERY.md` | P2 | M2 | integration |
