...
| PIGE-UI-001 | The note reader renders polished safe Markdown; editing and title rename preserve valid frontmatter, stable identity, links, citations, drafts, and IME behavior. | `docs/UI_PROTOTYPE.md` | P6 | M5 | integration |
