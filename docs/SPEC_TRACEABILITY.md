...
| PIGE-SEC-006 | A machine-local secret-storage adapter keeps values out of the vault and default backups; Provider integration loads them without OS-keychain access. | `docs/SECURITY_THREAT_MODEL.md` | P1 | M1 | integration |
