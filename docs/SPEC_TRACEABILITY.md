...
| PIGE-DATA-002 | Dataset inspection and natural-language analysis use bounded typed local query plans, including one declared same-Dataset relation join, and exact revision/schema/row/range/aggregate evidence refs; whole payloads and unrestricted SQL never reach the model or renderer. | `docs/CONTEXT_ASSEMBLY_AND_RETRIEVAL_POLICY.md` | P6 | M5 | integration |
