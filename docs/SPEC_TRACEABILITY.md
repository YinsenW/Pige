...
| PIGE-DATA-003 | Managed Collections support stable typed fields, views, relations/formulas and editable derived lookup/rollup definitions, with reversible Agent row/schema/view changes through Activity/Undo; destructive, external-write, authority, and conflict boundaries remain exceptional. | `docs/DATA_ARCHITECTURE.md` | P7 | M5 | integration |
