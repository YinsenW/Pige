...
| PIGE-JOB-006 | Reference-based history is restart-safe and compactable; bounded vault summaries reopen exact timelines but grant no follow-up authority. | `docs/JOB_OPERATION_AND_RECOVERY.md` | P7 | M5 | integration |
