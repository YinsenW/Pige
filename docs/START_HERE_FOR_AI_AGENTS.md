...
| CSV, XLSX, database files, Datasets, Collections, structured query and citations | `docs/DATA_ARCHITECTURE.md`, `docs/DOMAIN_MODEL.md`, `docs/PARSER_INGEST_SPEC.md`, `docs/SOURCE_STORAGE_STRATEGY.md`, `docs/LOCAL_DATABASE_DESIGN.md`, `docs/CONTEXT_ASSEMBLY_AND_RETRIEVAL_POLICY.md`, `docs/SYNC_CONFLICT_AND_MIGRATION.md`, `docs/SECURITY_THREAT_MODEL.md` |
