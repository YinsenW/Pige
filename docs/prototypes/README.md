...
- Independent Settings preserves the workspace and pane state without reload; background
  exclusion and heading focus are atomic, close restores the invoker, and no-invoker
  deep links fall back to expanded Home.
