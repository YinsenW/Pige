...
export type {
  ...
  DictationLanguagePreferenceRequest,
  DictationLanguagePreferenceRequestId,
  DictationLanguagePreferenceResult,
  DictationLanguagePreferenceSummary,
  SetDictationLanguagePreferenceRequest,
  SetDictationLanguagePreferenceResult,
  PaddleOcrCatalogComponent,
  PaddleOcrDisableRequest,
...
export interface LibraryRelatedPage {
  ...
  readonly relationType: "links_to" | "related_to" | "mentions_entity" | "contradicts" | "supports" | "supersedes" | "answers" | "broader_than";
}
...
export interface PigeDesktopApi {
  ...
  readonly notes: {
    ...
    readonly changeEntityMention: (
      request: NoteChangeEntityMentionRequest
    ) => Promise<NoteChangeEntityMentionResult>;
