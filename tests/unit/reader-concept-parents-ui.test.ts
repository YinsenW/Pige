...
describe("ReaderConceptParents", () => {
  it("searches, adds, and fences duplicate activation", async () => {
    ...
    expect(input.getAttribute("aria-label")).toBe("note.conceptParents.searchPlaceholder");
...
function parentItem() { return { pageId: "page_20260801_concept02", title: "Broader idea",
